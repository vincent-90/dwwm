...
if (isset($_POST['submit'])) {
    ...
    if (isset($mail) && isset($mailConfirm)) {
            ...
            if (!empty($_POST['password'])) {
                if (!empty($_POST['passwordConfirm'])) {
                    if ($_POST['password'] == $_POST['passwordConfirm']) {
                        ...
                        $accountMessage = 'Félicitation, le compte à bien été créer.';
                    } else {
        ...
        $accountMessage = 'Erreur, le compte n\'a pu être créer.';
    }

//    if (isset($_POST['avatar'])) {
//        if (!empty($_POST['avatar'])) {
//            if (preg_match($usernameRegex, $_POST['avatar'])) {
//                $avatar = htmlspecialchars($_POST['avatar']); 
//            } else {
//                $formError['avatar'] = 'Erreur, saisie invalide.';
//            }
//        } else {
//            $formError['avatar'] = 'Erreur, veuillez remplir le champ.';
//        }
//    }
